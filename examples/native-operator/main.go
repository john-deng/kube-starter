...
import (
	...
	examplev1 "github.com/hidevopsio/kube-starter/examples/api/v1" // Ensure this import path is correct
	"github.com/hidevopsio/kube-starter/examples/controllers"
)
